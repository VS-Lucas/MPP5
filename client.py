...
class Client:
    ...
    def buildSocketUDP(self) -> None:
        ...
        self.sckt.bind(('192.168.0.105', 55555))
    ...
    def sendfile(self) -> None:
        ...
        with open(self.path, 'rb') as file:
            ...
            try:
                startTime = time.time()
                while pathsize > 0:
                    # if 220322835 - pathsize >= 104857600:
                    #     break
                    self.cont += 1
        ...
        self.sckt.sendto(bytes(f'{byte_data} enviado', 'utf-8'), self.con)
...
client = Client('179.152.253.19', 55555, "path-54MB.pdf", 1024)
